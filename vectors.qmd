...
![](images/clipboard-2831182069.png)
...
![](images/clipboard-2063416601.png){width="592"}
...
Data frame is a table. Each column of the table is a vectors.

```{r}
people <- 
  data.frame(name, birthday, height, weight, is_married)
